...
| Method | Endpoint | 설명 |
|---|---|---|
| POST | `/api/watched-movies` | 시청 기록 등록 (또는 평점 갱신) |
| GET | `/api/watched-movies` | 내가 본 영화 목록 조회 |
| PUT | `/api/watched-movies/{movieId}` | 평점 수정 |
| DELETE | `/api/watched-movies/{movieId}` | 시청 기록 삭제 |
...
| 9/3 ~ 9/11 | 시청 기록 관리 UI, 추천 시스템 |
| 9/12 ~ 9/15 | 스타일링, 버그 수정, 선택 기능 |
| 9/16 ~ 9/18 | 배포, README 정리, 최종 점검 |
